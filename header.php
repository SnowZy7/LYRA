    ...
    <header class="header">
        <div class="header-container">
            ...
            <a href="<?php echo esc_url($home_link); ?>">
                <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Logo.svg" alt="LYRA Logo" class="logo">
            </a>
            <div class="search-container">
                <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    <button type="submit" class="search-button" aria-label="Rechercher">
                        <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Search loupe.svg" alt="Rechercher" class="search-icon">
                    </button>
                </form>
            </div>
            <div class="profile-menu">
                ...
                <div class="dropdown-menu" id="dropdownMenu">
                    ...
                    <a href="<?php echo esc_url($login_url); ?>">
                        <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/changer-de-compte.svg" alt="Changer" class="dropdown-icon">
                        <span>Changer de compte</span>
                    </a>
                    <a href="#">
                        <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/déco.svg" alt="Déconnexion" class="dropdown-icon">
        ...
        <?php
            ...
            $profile_create_link = $page_profil ? add_query_arg('open_new_post', '1', $page_profil) : '#';
        ?>
        <nav class="left-menu" aria-label="Menu vertical">
            <a class="menu-item" href="<?php echo esc_url($page_categories ?: '#'); ?>">
                <span class="icon" aria-hidden="true">
                    <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Catégories.svg" alt="Catégories" width="24" height="24">
                </span>
                <span class="label" aria-hidden="true">Catégories</span>
            </a>
            <a class="menu-item" href="<?php echo esc_url($page_decouvrir ?: '#'); ?>">
                <span class="icon" aria-hidden="true">
                    <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Découvrir.svg" alt="Découvrir" width="24" height="24">
                </span>
                <span class="label" aria-hidden="true">Découvrir</span>
            </a>
            <a class="menu-item" href="<?php echo esc_url($page_profil ?: '#'); ?>">
                <span class="icon" aria-hidden="true">
                    <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Profil.svg" alt="Profil" width="24" height="24">
                </span>
                <span class="label" aria-hidden="true">Profil</span>
            </a>
            <a class="menu-item menu-create" href="<?php echo esc_url($profile_create_link); ?>" aria-label="Créer un post">
                <span class="icon" aria-hidden="true">
                    <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/+.svg" alt="Créer" width="24" height="24">
                </span>
                <span class="label" aria-hidden="true">Créer</span>
            </a>
            <a class="menu-item" href="<?php echo esc_url($page_parametres ?: '#'); ?>">
                <span class="icon" aria-hidden="true">
                    <img src="<?php echo $theme_uri; ?>/assets/svg/svg_menu/Paramètres.svg" alt="Paramètres" width="24" height="24">
                </span>
